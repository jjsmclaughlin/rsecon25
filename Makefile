...
dcr_rel:
	...
	python -m spacy debug data ./configs/t2v_rcx.cfg -c ./relation_extractor_context/custom_functions.py --paths.train ./docbins/dcr_train_mu.spacy --paths.dev ./docbins/dcr_dev_mu.spacy
	python -m spacy debug data ./configs/tra_rcx.cfg -c ./relation_extractor_context/custom_functions.py --paths.train ./docbins/dcr_train_mu.spacy --paths.dev ./docbins/dcr_dev_mu.spacy
	#
	# Train
