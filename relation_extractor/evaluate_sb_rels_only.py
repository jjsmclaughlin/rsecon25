    ...
    for gold in docs:
        ...
        if print_details:
            ...
            for value, rel_dict in pred._.rel.items():
                if (rel_dict['Injurybody'] > 0.4):
                    print('PRED: ' + str(value) + ' : ' + str(span_start_to_ent[value[0]]) + ' : ' + str(span_start_to_ent[value[1]]) + ' : ' + str(rel_dict))
            ...
            for value, rel_dict in pred._.rel.items():
                ...
                if gold_labels:
                    print('GOLD: ' + str(value) + ' : ' + str(span_start_to_ent[value[0]]) + ' : ' + str(span_start_to_ent[value[1]]) + ' : ' + str(rel_dict))
                    #print(
